...
/* BMP file
 ...
 Essentially the format is:
  BMP FILE
      File Header
      DIB Header
      Pallette/Color Table (if any)
      Pixel Data
 
Notes:
 
Pallette/Color Table
 We are not using one (mainly for 8 bit color) , we dont need to include one. See reference above for more information
